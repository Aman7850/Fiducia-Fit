  ...
  return (
    ...
    <ImageBackground source={require('./Images/background.png')} resizeMode="cover" style={styles.image}>
        ...
        <View style = {{justifyContent: 'center', alignItems: 'center', marginTop: '30%'}}>
            <Image source={require('./Images/logo1.png')} resizeMode="cover" style={styles.Logo1} />
            <Image source={require('./Images/logo2.png')} resizeMode="cover" style={styles.Logo2} />
            <Image source={require('./Images/logo3.png')} resizeMode="cover" style={styles.Logo3} />
            <Image source={require('./Images/logo4.png')} resizeMode="cover" style={styles.Logo4} />
            <Image source={require('./Images/logo.png')} resizeMode="cover" style={styles.tinyLogo} />
        </View>
