...
const SignupScreen = () => {
    ...
    const [cib_sn, setcib_sn] = useState('');
    const [weight, setWeight] = useState('');
    const [height, setHeight] = useState('');
    const [visible, setvisible] = useState(false);
    const [confirm, setConfirm] = useState(null);
    const [error, seterror] = useState('Entry matching error!');


    const searchuser = async () => {
        console.log(username, password, cpassword, first_name, middle_name, last_name, cib_sn, token, weight, height, email, phone, date, month, year);
        setvisible(true);
      ...
      console.log(json12,'I am!');
        ...
        if (!first_name.trim()) {
          ...
          if (email.trim() !== reemail.trim()) {
            alert('Your Email ID does not matched...');
            console.error(error);
            navigation.navigate('SignupScreen') 
            return;
          }
                ...
                <Text style={{fontSize: 21, fontWeight: '900', color: 'black', marginTop: 10}}>Create Account</Text>
                    ...
                    <View style={{marginTop: 20}}>
                        <Input
                            ...
                            color={'black'}
                            InputLeftElement={<Icon name={'lock'}  size={20} ml="2" color="#00F2E0" />}
                            InputRightElement={<Icon name={cpasswordVisible ? "visibility-off" : "visibility"} size={25} ml="2" color="black" onPress={() => setcPasswordVisible(!cpasswordVisible)} />}
                            underlineColorAndroid="transparent"
                    ...
                    <View style={{marginTop: 20}}>
                            <Input
                                ...
                                InputLeftElement={<Icon name={'email'}  size={20} ml="2" color="#00F2E0" />}
                                underlineColorAndroid="transparent"
                                value = {reemail} onChangeText = {(text) => setReEmail(text)}
                            />
                    </View>
                    ...
                    <View style={{marginLeft: 8}}>
                        <Text style={{marginLeft: 20}}>Gender</Text>
                            <Radio.Group>
                                    ...
                                    <Radio value="2" colorScheme="rgba(53, 242, 224, 1)" size="md" my={1} onValueChange={itemValue => setMale(itemValue)}>
                                        M
                                    </Radio>
                                    <Radio value="3" colorScheme="rgba(53, 242, 224, 1)" size="md" my={1}  onValueChange={itemValue => setFemale(itemValue)}>
                                        F
                                    </Radio>
                                    </HStack>
                            </Radio.Group>
